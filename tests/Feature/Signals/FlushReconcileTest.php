 ...
 *
 * @see FlushReconcileAbsenceTest for the "absent from the read" vs "confirmed empty" cases,
 *      extracted to a sibling file purely to keep this one under STANDARDS §6b's 500-line cap.
 */
